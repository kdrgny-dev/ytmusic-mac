let modelTR: [String: String] = [
    ...
    "vm.radio.genreSection": "%@ radyoları",
    "vm.radio.genreSection.subtitle": "Dinlediğin %@ sanatçılarından",
    "vm.radio.decades.title": "Yıllara göre",
    "vm.radio.decades.subtitle": "En çok dinlediğin on yıllardan radyolar",
    // Ünlü uyumu tek bir format dizesiyle çözülmüyor: "90'lar" ama "2000'ler".
    "vm.radio.decade.1930": "30'lar",
    "vm.radio.decade.1940": "40'lar",
    "vm.radio.decade.1950": "50'ler",
    "vm.radio.decade.1960": "60'lar",
    "vm.radio.decade.1970": "70'ler",
    "vm.radio.decade.1980": "80'ler",
    "vm.radio.decade.1990": "90'lar",
    "vm.radio.decade.2000": "2000'ler",
    "vm.radio.decade.2010": "2010'lar",
    "vm.radio.decade.2020": "2020'ler",
